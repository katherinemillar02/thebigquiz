...
::: {=html}
<form id="q4">
  <input type="radio" name="q4" value="a"> A. Because they have the longest ovipositors.<br>
...
**Question 5: What's bigger, a Medfly or a House Fly?**

::: {=html}
<form id="q5">
  <input type="radio" name="q5" value="a"> A Medfly <br>
  <input type="radio" name="q5" value="b"> B. House Fly <br>
...
**Question 6: What size can a Medfly larvae grow to?**


::: {=html}
<form id="q6">
  <input type="radio" name="q6" value="a"> A.0.8 inches.<br>
  <input type="radio" name="q6" value="b"> B.0.6 inches.<br>
  <input type="radio" name="q6" value="c"> C.0.4 inches.<br>
  <input type="radio" name="q6" value="d"> D.0.2 inches.<br><br>
