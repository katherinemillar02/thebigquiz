...
<form id="q2">
  ...
  <input type="radio" name="q2" value="d"> D. They're bigger than *Drosophilia*, so they can do more <br><br>
...
::: {=html}
<form id="q4">
  <input type="radio" name="q4" value="a"> A. They have bigger ovipositors .<br>
  <input type="radio" name="q4" value="b"> B. They are more colourful.<br>
  <input type="radio" name="q4" value="c"> C. they travel in packs.<br>
...
::: {=html}
<form id="q5">
  <input type="radio" name="q5" value="a"> A. Africa.<br>
  <input type="radio" name="q5" value="b"> B. Antartica.<br>
  <input type="radio" name="q5" value="c"> C. Brussels.<br>
  <input type="radio" name="q5" value="d"> D. Australia.<br><br>
  <button type="button" onclick="checkAnswer('q5','a')">Submit</button>
</form>
